...
console.log('=========================================');
console.log('APP DE GUÍAS TURÍSTICAS VIRTUALES - 3407186');
console.log('=========================================');
console.log('');
...
console.log('Categoría:       [Turismo cultural - religioso]');
...
//Precio del recorrido turístico
console.log('Valor principal:    [40000]');
...
//Precio del recorrido turístico con descuento del 25%
console.log('Valor calculado:    ', 20000 * 0.75); // TODO: reemplaza 0 con tu cálculo
...
//Incluye guía turístico en el recorrido
console.log('Incluye guía turístico en el recorrido');
...
console.log('[Explora toda Colombia con nosotros]');
