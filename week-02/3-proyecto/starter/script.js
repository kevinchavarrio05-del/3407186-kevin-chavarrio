...
const itemName = "Recorrido Virtual Monserrate";
...
const itemCategory = "Turismo cultural - religioso";
...
const itemQuantity = 10; // Numero de recorridos disponibles en la app
// reemplaza 0 con el número adecuado
...
const isItemAvailable = true; //El recorrido esta disponible
...
const pendingGuide = null; //Guia turistico interactivo aun no Disponible
// cambia el nombre a algo de tu
...
console.log(`Disponibñe: ${isItemAvailable}`);
...
console.log("Valor pendiente:", pendingGuide);
console.log("typeof null:", typeof pendingGuide)
console.log("")
// TODO: Agrega typeof y la verificación === null
console.log("¿Es null?:", pendingGuide === null);
