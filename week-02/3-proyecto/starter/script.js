...
const itemName = "APP DE GUIAS TURISTICAS VIRTUALES";
...
const itemCategory = "Recorrido Virtual Monserrate";
...
const itemQuantity = 20; // reemplaza 0 con el número adecuado
...
const pendingGuide = null; // cambia el nombre a algo de tu dominio
