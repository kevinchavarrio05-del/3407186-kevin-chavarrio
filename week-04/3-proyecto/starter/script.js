...
const rawEntityName = "  Recorrido Virtual Monserrate  ";

// TODO: Define una categoría o tipo (string)
const entityCategory = "Turismo Cultura y Religioso";

// TODO: Define un código identificador (string)
// Elige un prefijo coherente con tu dominio
const entityCode = "Guia-001";

// TODO: Define una descripción corta (string)
// Debe contener varias palabras para usar includes/slice

//
const entityDescription = "Recorrido virtual por el cerro de Monserrate con guia turistica digital.";
...
const descriptionIsRelevant = entityDescription.includes("turistica");
...
console.log(`¿Descripción contiene 'turistica'?: ${descriptionIsRelevant}`);
...
const notification = `📢 Nuevo recorrido disponible: ${entityName} (${entityCode})`;
